                    ...
                    <div class="col-xxl-7">
                        ...
                        <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div class="profile bg-gradient-primary-to-secondary">
                                ...
                                <div class="dots-1">
                                    <!-- SVG Dots-->
                                    <svg style="enable-background: new 0 0 191.6 1215.4" version="1.1"
                                        viewBox="0 0 191.6 1215.4" x="0px" xml:space="preserve"
            ...
            <div class="container px-5">
                <div class="row">
                    <div class="text-center">
                        <h2 class="display-5 fw-bolder"><span class="text-gradient d-inline"> Alat Musik
                                Tradisonal</span></h2>
                    </div>
                    <hr>
                    {{-- card list alatmusik --}}
                            ...
                            <div class="col-md-3">
                                <div class="card">
                                    <img alt="..." class="card-img-top"
                                        src="{{ asset('uploaded/' . $item->image) }}">
                                    <div class="card-body">
                                        <h5 class="card-title text-center">{{ $item->name }}</h5>
                                        <p class="card-text" style="font-size: .8em">{{ $item->description }}</p>
                                        <p class="card-text">Ketersediaan: {{ $item->totalTersedia }}</p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="col-xxl-8">
                        <div class="text-center my-5">
                            ...
                            <p>
                                ...
                                kemudian cek ketersediaan alat musik yang ingin anda pinjam. Jika alat musik tersedia,
                                anda dapat melakukan peminjaman dengan mengisi form peminjaman yang telah disediakan.
                            </p>
                            {{-- redirect ke register --}}
                            <a class="btn btn-primary" href="{{ url('users-used/register') }}">Daftar</a>
                        </div>
                    </div>
                </div>
            </div>
